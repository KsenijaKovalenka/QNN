...
Convolutional neural network with a quantum layer 
...
n_qubits = 2
#dev = qml.device("default.qubit", wires=n_qubits, shots=2024)  # shots to make it behave like quantum comuter
...
n_layers = 6 # number of quantum layers
...
with torch.no_grad():
    ...
    np.savetxt("cnn_c_q_run4.txt", loss_array)
