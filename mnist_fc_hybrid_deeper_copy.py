...
weights_array_1 = np.zeros((epoch_array_size*num_epochs, n_layers))
weights_array_2 = np.zeros((epoch_array_size*num_epochs, n_layers))
...
with torch.no_grad():
    ...
    # ax1.scatter(steps_array, initialisations_array_2, c=mapped_colors, s=0.7)
    # ax2.scatter(steps_array, weights_array_1[:,0], c=mapped_colors, s=0.7)
    # ax2.scatter(steps_array, weights_array_2[:,0], c=mapped_colors, s=0.7)
